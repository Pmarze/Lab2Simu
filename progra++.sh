...
if [ $Extension = "cpp" ]; then							# la extensión sea .c, ponemos "c"  sin el punto porque no es necesario,
	...
	echo "librerias: iostream, $librerias" >> $nombre_archivo			##Añadimos las librerias  al archivo
	...
	echo "#include <iostream>" >> $nombre_archivo 				##Añadimos la libreria stdio a nuestro programa
else
	exit
fi
